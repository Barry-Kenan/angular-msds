import { Action } from "@ngrx/store"
 ...
 export class CountTextAction implements Action {
    readonly type = countActionsType.text
 ...
 export type CountActions = CountIncreaseAction | CountDecreaseAction | CountClearAction | CountUpdatedAtAction | CountTextAction